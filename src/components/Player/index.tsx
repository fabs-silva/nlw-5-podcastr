...
export function Player() {
  ...
  const { episodeList, currentEpisodeIndex, isPlaying, isLooping, isShuffling, togglePlay, toggleLoop, toggleShuffle, setPlayingState, hasPrevious, hasNext, playPrevious, playNext, clearPlayerState } = usePlayer();
  ...
  return (
    <aside className={styles.playerContainer}>
      ...
      { episode ? (
        <section className={styles.currentEpisode}>
          ...
          <div className={styles.slider}>
            {episode ? (
              <Slider
                ...
                handleStyle={{ boxShadow: '0px 0px 4px 3px #04d361' }}
              />
            ) : (
